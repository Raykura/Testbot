...
class Bot(BaseBot):
    ...
    async def on_chat(self, user: User, message: str) -> None:
        ...
        if message.lower().startswith("clap"):
            ...
            elif parts[1].strip().lower() == "all":  # "clap@all <number>"
        ...
        # Heart reaction logic with specified number of hearts
            ...
            elif parts[1].strip().lower() == "all":  # "heart@all <number>"
        ...
        elif message.lower().startswith("!iwallet") or message.lower().startswith("!wallet"):
    ...
    async def check_wallet(self, user: User) -> None:
        ...
        await self.highrise.chat(f"The bot's wallet contains: {bot_amount} funds.")
